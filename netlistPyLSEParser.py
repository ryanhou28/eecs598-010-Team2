...
# Usage:
# python netlistPyLSEParser.py <verilog_netlist_file> [-o <output_file>]
#   Example:
#   python netlistPyLSEParser.py synth_scripts/comb85/c6288_N.v
#   python netlistPyLSEParser.py synth_scripts/comb85/c6288_N.v -o my_c6288_N.py
# If -o is not specified, the output file will be named <verilog_netlist_file>_PyLSE.py in the same directory as the script
# For help:
# python netlistPyLSEParser.py -h

# Description:
# The script takes a Verilog netlist file generated from the given synthesis scripts. Currently, this script only works on combinational designs (without feedback loops).
