...
def test_single_input(input_feature_bin_arr):
    ...
    for input_feature_bin in input_feature_bin_arr:
        ...
        starting_delay = 100
        for i in range(8):
            input_features.append(pylse.inp_at(input_feature_T[i][0]*T + starting_delay, name=f"input_feature_{cnt}_bit{i}_p"))
            input_features.append(pylse.inp_at(input_feature_T[i][1]*T + starting_delay, name=f"input_feature_{cnt}_bit{i}_n"))
